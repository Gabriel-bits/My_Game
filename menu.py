...
from data.música.music_codg.musicas import*
...
def main_menu():
    while True:
        ...
        b_imag("personagens/Nave.png",110, 70, 450, 150, objectaleatori)
        b_imag("Botons/layout_.png", 170, 70, -10, 10, Bots_menu)
        ...
        button_1 = b_imag("Botons/Layout.png", 180, 65, 55, 103, Bots_menu)
        button_2 = b_imag("Botons/Layout.png", 180, 65, 55, 203, Bots_menu)
...
def Pause():
    while True:
        imag(TELA+"backg2.png", tela_dx, tela_dy, 0, 0,objectaleatori) 
        pygame.sprite.Group().update()
        objectGroup.draw(tela)
        object_backg.draw(tela)
        objectaleatori.draw(tela)
        ...
        reset = b_imag("personagens/Nave.png",110, 70, 450, 150, objectaleatori)
